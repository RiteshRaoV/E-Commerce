...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'seller', 'title', 'description',
                  'price', 'discounted_price', 'stock', 'brand', 'category', 'image']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['user', 'order_items', 'total_amount',
...
class StoreProductListSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        new_products = [StoreProduct(store=store, product=product)
                        for product in products if product.id not in existing_products]
